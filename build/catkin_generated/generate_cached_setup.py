...
try:
    ...
    for workspace in 'F:/catkin_ws/devel;C:/opt/ros/melodic/x64'.split(';'):
...
code = generate_environment_script('F:/catkin_ws/devel/env.bat')

output_filename = 'F:/catkin_ws/build/catkin_generated/setup_cached.bat'
